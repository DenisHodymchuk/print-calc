  ...
  return (
    <div className="relative">
      <button
        ...
        type="button"
        onClick={() => setOpen(o => !o)}
        className="h-8 rounded-lg border border-input bg-transparent px-3 py-0 text-sm flex items-center gap-1.5 hover:bg-accent focus:outline-none focus:ring-2 focus:ring-ring/50"
      >
        {label}
